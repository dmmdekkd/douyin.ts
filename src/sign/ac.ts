...
const HEAD_SEC = '_02B4Z6wo00f01'
const HEAD_MS = '_02B4Z6wo00101'
...
export function acSignatureMs (options: AcMsOpts): string {
  const { url, acNonce, userAgent } = options
